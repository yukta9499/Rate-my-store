...
__export(index_exports, {
  ...
  download: () => import_chunk_3GRLNIQA.download,
  engineEnvVarMap: () => import_chunk_PXQVM7NP.engineEnvVarMap,
  getBinaryEnvVarPath: () => import_chunk_PXQVM7NP.getBinaryEnvVarPath,
  getBinaryName: () => import_chunk_3GRLNIQA.getBinaryName,
  getCacheDir: () => import_chunk_YJOPKU47.getCacheDir,
  getProxyAgent: () => import_chunk_VAPNG6TS.getProxyAgent,
  getVersion: () => import_chunk_3GRLNIQA.getVersion,
  maybeCopyToTmp: () => import_chunk_3GRLNIQA.maybeCopyToTmp,
  overwriteFile: () => import_chunk_YJOPKU47.overwriteFile,
  plusX: () => import_chunk_3GRLNIQA.plusX,
  vercelPkgPathRegex: () => import_chunk_3GRLNIQA.vercelPkgPathRegex
});
module.exports = __toCommonJS(index_exports);
var import_chunk_3GRLNIQA = require("./chunk-3GRLNIQA.js");
